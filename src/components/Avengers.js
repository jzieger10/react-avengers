const avengers = [
    // I know these aren't really Avengers, but I just needed data, so I copied the JSON from the animals project in the training kit and slightly modigied the first few.
  { id: 1, name: "Captain America", species: "Smithopsis crassicaudata" },
  { id: 2, name: "Iron Man", species: "Ara ararauna" },
  { id: 3, name: "Hulk", species: "Certotrichas paena" },
  { id: 4, name: "Spider Man", species: "Dusicyon thous" },
